...
## All contribution together and zoom on clusters {.smaller}
...
## We can identify contributors characteristics

### Blog post network

* _Maëlle Salmon_ have the max of contributions as active member.
* _Noam Ross_ have the higest degree. It is the most connected. And also have the higest centrality.
* _Laura DeCicco_ is the no staff member that have the higest degree.
* _Yani Bellini Saibene_ have the max of contribution in other language than English.
* _Alejandra Bellini_ y _Lucio Casalla_ the no staff member that have the max contribution in other language than English.
