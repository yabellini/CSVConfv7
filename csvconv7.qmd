...
::: {.notes}
The methods suggested in the bibliography are surveys to the members of the community where they are asked with whom they have contact, what type of relationship. Or a community mapping work with the members by bringing them together for one or two days of work to diagram these relationships.

As you can imagine, this can be costly in time and money.  So we thought, is it possible that we could collect that data in an automated or semi-automated way? Is it possible that we already have that data in another format and we can accommodate it to analyze the connectivity of our community?
